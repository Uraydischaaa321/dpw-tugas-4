...
<div class="hero_area">
    <div class="hero_bg_box">
      <img src="{{ url('public/shop') }}/images/hero-bg.jpg" alt="">
    </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="{{ url('public/shop') }}/images/p1.png" alt="">
            </div>
            <div class="detail-box">
              <a href="">
                Vegetable
        ...
        <div class="col-md-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="{{ url('public/shop') }}/images/p2.png" alt="">
            </div>
            <div class="detail-box">
              <a href="">
                Vegetable
        ...
        <div class="col-md-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="{{ url('public/shop') }}/images/p3.png" alt="">
            </div>
            <div class="detail-box">
              <a href="">
                Vegetable
        ...
        <div class="col-md-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="{{ url('public/shop') }}/images/p4.png" alt="">
            </div>
            <div class="detail-box">
              <a href="">
                Vegetable
        ...
        <div class="col-md-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="{{ url('public/shop') }}/images/p5.png" alt="">
            </div>
            <div class="detail-box">
              <a href="">
                Vegetable
        ...
        <div class="col-md-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="{{ url('public/shop') }}/images/p6.png" alt="">
            </div>
            <div class="detail-box">
              <a href="">
                Vegetable
        ...
        <div class="col-md-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="{{ url('public/shop') }}/images/p7.png" alt="">
            </div>
            <div class="detail-box">
              <a href="">
                Vegetable
        ...
        <div class="col-md-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="{{ url('public/shop') }}/images/p8.png" alt="">
            </div>
            <div class="detail-box">
              <a href="">
                Vegetable
        ...
        <div class="col-md-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="{{ url('public/shop') }}/images/p9.png" alt="">
            </div>
            <div class="detail-box">
              <a href="">
                Vegetable
